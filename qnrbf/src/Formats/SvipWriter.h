...
protected:
    ...
    QSharedPointer<UserClassTypeObject> createClassDef_ReverbPreset(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_NoteHeadTag(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_AppModel(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_SongTempoList(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_SongBeatList(qint32 objectId);
    QSharedPointer<SystemClassTypeObject> createClassDef_TrackList(qint32 objectId);
    QSharedPointer<SystemClassTypeObject> createClassDef_SongTempoListBuf(qint32 objectId);
    QSharedPointer<SystemClassTypeObject> createClassDef_SongBeatListBuf(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_SingingTrack(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_InstrumentTrack(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_SongTempo(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_SongBeat(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_NoteList(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_LineParam(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_BeatSize(qint32 objectId);
    QSharedPointer<SystemClassTypeObject> createClassDef_NoteListBuf(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_Note(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_NotePhoneInfo(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_VibratoStyle(qint32 objectId);
    QSharedPointer<UserClassTypeObject> createClassDef_VibratoPercentInfo(qint32 objectId);

    QSharedPointer<DeferredReferenceObject> createReference(qint32 id);

    QSharedPointer<StringObject> createString(const QString &value, qint32 objectId);

    QSharedPointer<PrimitiveObject> createPrimitive(const PrimitiveValue &value);

    QSharedPointer<PrimitiveListObject> createPrimitiveList(const PrimitiveValueArray &values,
                                                            qint32 objectId);

    QSharedPointer<ObjectListObject> createObjectList(const QList<ObjectRef> &values,
                                                      qint32 objectId);
